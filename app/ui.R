...
custom_css_js <- tagList(
  tags$head(
    ...
    tags$style(HTML("
      /* - GLOBAL SCROLL FIX FOR ANCHOR LINKS - */
      ...
      /* - AGGRESSIVE ANTI-GAP FIX FOR HOME PAGE - */
      ...
      /* =========================================================
         RESTORED: AVAILABLE NOW BADGE & ACCORDION & PULSE TEXT
         ========================================================= */
      ...
      /* =========================================================
         BACKGROUND OVERLAY (LOCKED SCREEN)
         ========================================================= */
      #progress_overlay {
      ...
      /* =========================================================
         CENTERED, MODERNIZED SHINY PROGRESS BAR
         ========================================================= */
      ...
      /* =========================================================
         STANDARD NOTIFICATIONS (Bottom Right)
         ========================================================= */
      ...
      /* - NAVBAR: Purple to Blue Gradient, White Text - */
      ...
      /* =========================================================
         SUBTLE RADIO BUTTON ACCENT (ANALYSIS TAB)
         ========================================================= */
      ...
      /* =========================================================
         MODERN TOXICITY SLIDER (TOXICITY TAB)
         ========================================================= */
