...
Two scoring models are supported: a therapeutic model that penalizes effector-cell toxicity using Bliss independence, and a mechanistic model that isolates effector-mediated modulation by adjusting for effector viability. Full mathematical details are provided in the accompanying manuscript.
